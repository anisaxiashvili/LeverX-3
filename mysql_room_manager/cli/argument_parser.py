...
class ArgumentParser:
    ...
    def _setup_arguments(self):
        ...
        analytics_parser = subparsers.add_parser('analytics', help='Run analytics queries')
        ...
        opt_parser = subparsers.add_parser('optimize', help='Database optimization analysis')
